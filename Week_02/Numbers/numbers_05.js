...
let roundedNumberdown = Math.floor(num);
let roundedNumberUp = Math.ceil(num);

console.log(`The rounded value is ${roundedNumber}`);
console.log(`The rounded down value is ${roundedNumberdown}`);
console.log(`The rounded up value is ${roundedNumberUp}`);